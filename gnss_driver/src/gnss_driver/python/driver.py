...
if __name__ == '__main__':
    ...
    try:
        while not rospy.is_shutdown():
            serial_data = port.readline().decode('latin-1')
            ...
            if serial_data == '':
                ...
                if "$GNGGA" in serial_data[0]:
                    ...
                    if int(serial_data[6]) < 4:
                        rospy.logwarn("Low fix quality")
                        continue
                    ...
                    gps_data.Altitude = float(serial_data[9])
                    ...
                    gps_data.Fix_quality = int(serial_data[6])
